...
func Commands() *cobra.Command {
	...
	wrapper.SetFlags(createCmd, flag.FlagSet{
		Optional: []flag.Flag{flag.TtName, flag.TtFnName, flag.TtFnParam, // jingtao change
	...
	wrapper.SetFlags(updateCmd, flag.FlagSet{
		...
		Optional: []flag.Flag{flag.TtFnName, flag.TtCron, flag.TtFnParam, flag.NamespaceTrigger}, //  jingtao change
	})
