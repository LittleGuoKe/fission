	...
	funcStore, controller := k8sCache.NewInformer(lw, &fv1.Function{}, resyncPeriod,
		k8sCache.ResourceEventHandlerFuncs{
			AddFunc: func(obj interface{}) {
				...
				// jingtao comment: my fission env will need global config, so this must be successful, but I dont want to change the logic now
				...
				// jingtao add give fission-fetcher the global configmap and secrets access.
